...
function drawAstryxBackground(doc) {
const pageWidth = doc.internal.pageSize.getWidth();
  ...
  // Outer border
  doc.setDrawColor(110, 86, 150);
  doc.setLineWidth(0.8);
  doc.roundedRect(10, 10, pageWidth - 20, pageHeight - 20, 6, 6);

  // Soft top banner
  doc.setFillColor(236, 225, 255);
  doc.roundedRect(16, 16, pageWidth - 32, 30, 6, 6, "F");

  // Title
  doc.setFont("helvetica", "bold");
  doc.setFontSize(24);
  doc.setTextColor(70, 45, 110);
  doc.text("Astryx", pageWidth / 2, 30, { align: "center" });

  doc.setFont("helvetica", "normal");
  doc.setFontSize(9);
  doc.setTextColor(95, 80, 120);
  doc.text("AI-Powered Bazi & Astrology Insight Report", pageWidth / 2, 39, {
    align: "center",
  });

  // Decorative divider
  doc.setDrawColor(190, 165, 220);
  doc.line(26, 54, pageWidth - 26, 54);

  // Left info card
  doc.setFillColor(255, 252, 246);
  doc.setDrawColor(230, 215, 245);
  doc.roundedRect(16, 62, pageWidth - 32, 38, 5, 5, "FD");

  doc.setFont("helvetica", "bold");
  doc.setFontSize(12);
  doc.setTextColor(80, 55, 120);
  doc.text("Personal Cosmic Profile", 24, 75);

  doc.setFont("helvetica", "normal");
  doc.setFontSize(9);
  doc.setTextColor(90, 90, 90);
  doc.text("Birth data, location, and time are used to generate a combined symbolic analysis.", 24, 86);

  // Main AI output section
  doc.setFillColor(255, 255, 255);
  doc.setDrawColor(220, 205, 235);
  doc.roundedRect(16, 110, pageWidth - 32, 118, 6, 6, "FD");

  doc.setFont("helvetica", "bold");
  doc.setFontSize(14);
  doc.setTextColor(70, 45, 110);
  doc.text("AI Interpretation", 24, 124);

  // Inner guide lines
  doc.setDrawColor(238, 230, 245);
  doc.line(24, 132, pageWidth - 24, 132);

  // Bottom note card
  doc.setFillColor(245, 240, 255);
  doc.setDrawColor(220, 205, 240);
  doc.roundedRect(16, 238, pageWidth - 32, 34, 5, 5, "FD");

  doc.setFont("helvetica", "bold");
  doc.setFontSize(11);
  doc.setTextColor(80, 55, 120);
  doc.text("Reflection Guide", 24, 251);

  doc.setFont("helvetica", "normal");
  doc.setFontSize(8.5);
  doc.setTextColor(95, 90, 105);
  doc.text(
    "This report is designed for self-reflection, personality exploration, and personal growth.",
    24,
    262
  );
  ...
  // Footer
  doc.setFontSize(8);
  doc.setTextColor(140, 125, 155);
  doc.text("Generated by Astryx · Eastern Bazi × Western Astrology × AI", pageWidth / 2, pageHeight - 12, {
    align: "center",
  });
}

function addAIContent(doc, aiText) {
  doc.setFont("helvetica", "normal");
  doc.setFontSize(10);
...
function handleDownloadPDF() {
  ...
  drawAstryxBackground(doc);

  addAIContent(
    doc,
    reading || "AI reading has not been generated yet."
  );

  doc.save("astryx-report.pdf");
}
